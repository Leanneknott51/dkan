...
import { shouldRender, parseDateString, toDateString, pad } from "@rjsf/core";
...
class dcDateWidget extends Component {
  static defaultProps = {
    time: false,
    disabled: false,
    readonly: false,
